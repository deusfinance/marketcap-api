class Network:
    ...
    def __init__(self, name: str):
        if name == Network.FANTOM:
            ...
            self.excludes = {
                ...
                'deus': [
                    '0xe3b6CC7b76a7f67BBCcb66c010780bE0AF31Ff05',  # Migrator
                    '0x714bCAF508c6e2e405EAA379BA54804EeD401add',  # AXL Gateway
            ...
            self.excludes = {
                'deus': [
                    ...
                    '0x77eeaf07C050a690f9B3C2E8e7642Cc3CBEcEEb4',  # ThenaBribe
            ...
            self.excludes = {
                'deus': [
                    '0x44Fa47B1787Db408803ED688c5dC7Eb88199050a',  # AXL gateway
                    '0xe3b6CC7b76a7f67BBCcb66c010780bE0AF31Ff05',  # Migrator
    ...
    @classmethod
    def deus_chains(cls):
        return cls.FANTOM, cls.POLYGON, cls.ARBITRUM, cls.BSC, cls.MAINNET, cls.AVAX, cls.KAVA, cls.BASE
...
XDEUS_TOTAL_SUPPLY = (403_784 + 9_400) * 10 ** 18
